...
4. Select the **Migrate from Single Server** button to start a migration from Single Server to Flexible Server. If this is the first time you're using the migration tool, an empty grid appears with a prompt to begin your first migration.
    ...
    ![Portal Pic2](./media/flexible-migration-grid.png "Portal Pic2")
...
2. Upon selecting the Single Server, you can observe a migration-related banner in the Overview tab. Select **Migrate now** to get started.
    ...
    ![Portal Pic3](./media/single-banner.png "Portal Pic3")
...
3. You're taken to a page with two options. If you've already created a Flexible Server and want to use that as the target, choose **Select existing**, and select the corresponding Subscription, Resource group and Server name details. Once the selections are made, select **Go to Migration wizard** and skip to the instructions under the **Setup tab** section in this page.
    ...
    ![Portal Pic4](./media/single-click-banner.png "Portal Pic4")
...
4. Should you choose to Create a new Flexible Server, select **Create new** and select **Go to Create Wizard**. This action takes you through the Flexible Server creation process and deploys the Flexible Server.
    ...
    ![Portal Pic5](./media/single-banner-create-new.png "Portal Pic5")
...
![Portal Pic6](./media/flexible-migration-setup.png "Portal Pic6")
...
The second property on the **Setup** tab is **Migration mode**. The migration tool offers offline mode of migration as default. Online mode is also supported.
...
![Portal Pic7](./media/flexible-migration-source.png "Portal Pic7")
...
After all the fields are filled in, select the **Next** button.
...
![Portal Pic8](./media/flexible-migration-target.png "Portal Pic8")
...
![Portal Pic9](./media/flexible-migration-database.png "Portal Pic9")
...
![Portal Pic10](./media/flexible-migration-review.png "Portal Pic10")
...
![Portal Pic11](./media/flexible-migration-monitor.png "Portal Pic11")
...
![Portal Pic12](./media/flexible-migration-progress.png "Portal Pic12")
...
![Portal Pic13](./media/flexible-migration-progress-dbclick.png "Portal Pic13")
...
![Portal Pic14](./media/flexible-migration-cutover.png "Portal Pic14")
...
![Portal Pic17](./media/flexible-migration-click-cutover.png "Portal Pic17")
...
![Portal Pic15](./media/flexible-migration-progress-dbsuccess.png "Portal Pic15")
...
![Portal Pic16](./media/flexible-migration-grid-complete.png "Portal Pic16")
